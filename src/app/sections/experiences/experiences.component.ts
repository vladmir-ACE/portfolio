...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ExperienceCardComponent, I18NextModule],
  template: `
   <div class="w-full bg-black">

   <div class="text-center text-white text-medium md:text-large"> {{ 'My Experience' | i18next }} </div>
...
export class ExperiencesComponent {
  ...
  experienceCards: ExperienceCard[] = [
    ...
    {
      icon: 'vlad:dmm',
      title: "Software Engineer at Dreammore",
